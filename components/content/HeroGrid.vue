...
<template>
    <div
        class="not-prose mt-16 sm:mt-24 content-visibility-visible contain-intrinsic-size-[auto_600px] overflow-x-clip"
    >
        <div
            class="flex items-center justify-center gap-3 sm:gap-5 py-4 md:gap-6 relative z-20"
        >
            <!-- col1 -->
            <div
            ...
            <!-- col2 -->
            <div
                class="flex flex-col gap-3 sm:gap-5 md:gap-6"
                v-parallax
                data-rellax-speed="1"
            >
                <div
                    class="relative aspect-[4/3] w-24 sm:w-36 md:w-52 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800"
                >
                    <NuxtImg
                        placeholder
                        sizes="sm:100vw md:50vw lg:220px"
                ...
                <div
                    class="relative aspect-[3/4] w-24 sm:w-36 md:w-52 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800"
                >
                    <NuxtImg
                        placeholder
                        sizes="sm:100vw md:50vw lg:220px"
            ...
            >
                <div
                    class="relative aspect-[2/3] w-44 sm:w-60 md:w-80 lg:w-96 flex-none overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-800"
                >
                    <NuxtImg
                        placeholder
